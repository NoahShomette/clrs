...
fn handle_menu(
    ...
    if menu_nav.0 == 0 {
        term.put_string([1, 13], "PLAY".fg(player_colors.get_color(0)));
    }

    if menu_nav.0 == 1 {
        term.put_string([1, 11], "MAP".fg(player_colors.get_color(0)));
    }
    if menu_nav.0 == 2 {
    ...
    if menu_nav.0 == 1 {
        ...
        if keyboard_input.just_pressed(KeyCode::D) {
            ...
            term.put_string([4, 11], ">".fg(player_colors.get_color(0)));
        }
    }
